...
case class ResultInitData(id:String,wigth:Double,timestamp:TimeStamp)
case class ResultData(shopId:String,nowData:Double,avgData:Double,window:TimeStamp,flag:Boolean)
case class ResultState(nowData:Double,avgData:Double,window:TimeStamp,flag:Boolean)

object ShopStreamKafka {
